...
| Action bar | Both `ClientboundSetActionBarTextPacket` and overlay system-chat call `Hud#setOverlayMessage`. Client-local overlay messages (e.g. jukebox "Now Playing") also do. |
